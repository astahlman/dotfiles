...
if !exists("g:EclimHome")
  ...
  let g:EclimHome = '/Users/astahlman/Documents/Programming/Tools/adt-bundle-mac-x86_64-20130219/eclipse/plugins/org.eclim_2.2.5'
  if has('win32unix')
...
if !exists("g:EclimEclipseHome")
  " set at build/install time.
  let g:EclimEclipseHome = '/Users/astahlman/Documents/Programming/Tools/adt-bundle-mac-x86_64-20130219/eclipse'
  if has('win32unix')
